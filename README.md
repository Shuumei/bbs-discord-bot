...
| :--- | :--- | :--- |
| `/bleach-lore` | ถาม-ตอบ เจาะลึกเนื้อเรื่อง บังไค และนิยาย CFYOW/SAFWY | `/bleach-lore topic:บังไคของมินาซึกิทำงานยังไง` |
| `/vs` | วิเคราะห์จำลองการต่อสู้ 2 ตัวละคร พร้อมสรุปเปอร์เซ็นต์ชนะ | `/vs character1:อิจิเบย์ เฮียวซึเบะ character2:ยูฮาบัคห์` |
| `/bbs-guide` | ขอคำแนะนำเมต้าเกม BBS (Guild Quest, กาชา, การบิลด์ตัว) | `/bbs-guide category:Guild Quest query:ตัวแบกสัปดาห์นี้` |
...
| `@BBSBot <คำถาม>` | คุยเล่นหรือปรึกษาเรื่องบลีชกับบอทโดยตรงในห้องแชต | `@BBSBot นายว่าระหว่างชุนซุยกับเคมปาจิใครเก่งกว่ากัน?` |
